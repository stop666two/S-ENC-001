...
class App {
  ...
  private buildLayout(): string {
    return [
      ...
      ,'    <button id="btn-lang" class="term-btn" data-i18n="btn.lang" data-i18n-title="hint.btn.lang">EN</button>'
      ,'    <button id="btn-theme" class="term-btn" data-i18n="btn.theme" data-i18n-title="hint.btn.theme">[theme]</button>'
      ,'  </div>'
      ,'</div>'
      ,'<div id="main-area">'
      ,'  <div id="sidebar">'
      ,'    <button id="btn-encrypt" class="term-btn" data-i18n="btn.encrypt" data-i18n-title="hint.btn.encrypt">[encrypt]</button>'
      ,'    <button id="btn-decrypt" class="term-btn" data-i18n="btn.decrypt" data-i18n-title="hint.btn.decrypt">[decrypt]</button>'
      ,'    <button id="btn-password" class="term-btn" data-i18n="btn.password" data-i18n-title="hint.btn.password">[password]</button>'
      ,'    <button id="btn-phrase" class="term-btn" data-i18n="btn.phrase" data-i18n-title="hint.btn.phrase">[phrase]</button>'
      ,'    <button id="btn-clear" class="term-btn danger" data-i18n="btn.clear" data-i18n-title="hint.btn.clear">[clear]</button>'
      ,'  </div>'
      ,'  <div id="content">'
